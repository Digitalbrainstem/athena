...
export const MODELS = {
  forge: `${K}/furniture/kitchenStove.glb`,
  workbench: `${K}/furniture/tableCross.glb`,
  anvil: `${K}/nature/stone_largeA.glb`,
  toolrack: `${K}/furniture/coatRackStanding.glb`,
  crate: `${K}/medieval/detail-crate.glb`,
  barrel: `${K}/medieval/barrels.glb`,
  cottage: `${K}/medieval/tower-base.glb`,
  marketStall: `${K}/furniture/table.glb`,
  fence: `${K}/nature/fence_simple.glb`,
  well: `${K}/nature/pot_large.glb`,
  bridge: `${K}/nature/bridge_wood.glb`,
  stonePath: `${K}/nature/path_stone.glb`,
  signpost: `${K}/nature/sign.glb`,
  lantern: `${K}/furniture/lampSquareTable.glb`,
  treeOak: `${K}/nature/tree_oak.glb`,
  treePine: `${K}/nature/tree_pineTallA.glb`,
  rockLarge: `${K}/nature/rock_largeA.glb`,
  rockCluster: `${K}/nature/stone_largeA.glb`,
  bush: `${K}/nature/plant_bushLarge.glb`,
  grass: `${K}/nature/grass_large.glb`,
  treasureChest: `${K}/furniture/cardboardBoxOpen.glb`,
