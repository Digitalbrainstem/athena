...
- [ ] **Content safety** — Research best practices for validating educational content for accuracy and age-appropriateness. Review existing tools and approaches (moderation APIs, custom classifiers, human-in-the-loop pipelines).
